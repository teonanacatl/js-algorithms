...
describe('Bubble sort', () => {
  test('sorts an array in descending order', () => {
    expect(bubbleSort(getArray().reverse())).toEqual(getSortedArray());
  });
});

describe('Selection sort', () => {
  test('sorts an array in descending order', () => {
    expect(selectionSort(getArray().reverse())).toEqual(getSortedArray());
  });
});

describe('Merge sort', () => {
  test('sorts an array in descending order', () => {
    expect(mergeSort(getArray().reverse())).toEqual(getSortedArray());
  });
});
